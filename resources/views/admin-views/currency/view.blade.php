                                        ...
                                        <div class="modal fade" id="editCurrency{{$data->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content mt-5">
                                                    <div class="modal-header">
                                                        @if(in_array($data->code,$required))
                                                            <label style="font-size: 10px"
                                                                   class="badge badge-soft-danger">According to the
                                                                requirements of payment gateway, You can not remove this
                                                                currency but can update.</label><br>
                                                        @endif
                                                    </div>
                                                    <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" name="name"
                                                                               ...
                                                                               {{in_array($data->code,$required)?'readonly':''}}
                                                                               value="{{$data->name}}">
                                                                    </div>
                                                                    <div class="col-md-6">
                                        ...
                                        <td>
                                            @if($data->code!='USD')
                                                <a type="button" class="btn btn-primary btn-sm btn-xs edit"
                                                   data-toggle="modal"
                                                   data-target="#editCurrency{{$data->id}}">
