                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="name">{{ trans('messages.Image')}}</label><span class="badge badge-soft-danger">( ratio 4:1 )</span>
                                    <br>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="name">{{ trans('messages.Image')}}</label><span class="badge badge-soft-danger">( ratio 3:1 )</span>
                                    <br>
                                    <div class="custom-file">
