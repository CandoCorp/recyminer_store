        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-lg-12 mb-3 mb-lg-12">
                ...
                <div class="card h-100">
                    ...
                    @php
                        $seller_products=\App\Model\Product::where(['added_by'=>'seller'])->pluck('id')->toArray();
                            $earning_from_sellers=[];
                                for ($i=1;$i<=12;$i++){
                                    $from = date('Y-'.$i.'-01');
                                    $to = date('Y-'.$i.'-30');
                                    $earning_from_sellers[$i]=\App\Model\AdminWalletHistory::whereIn('product_id',$seller_products)->whereBetween('created_at', [$from, $to])->sum('amount');
                                }
                    @endphp
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-sm mb-2 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    @php($amount=array_sum($array))
                                    <span class="h5 mb-0">
                                        <i class="legend-indicator bg-primary"></i>
                                        In-House : {{\App\CPU\BackEndHelper::usd_to_currency($amount)." ".\App\CPU\BackEndHelper::currency_symbol()}}
                                    </span>
                                </div>
                                <div class="d-flex align-items-center mt-2">
                                      <span class="h6 mb-0">
                                          <i class="legend-indicator bg-success"></i>
                                        From Seller : {{\App\CPU\BackEndHelper::usd_to_currency(array_sum($earning_from_sellers))." ".\App\CPU\BackEndHelper::currency_symbol()}}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="chartjs-custom">
                            ...
                            "data": {
                              ...
                              {
                                "data": [{{$earning_from_sellers[1]}},{{$earning_from_sellers[2]}},{{$earning_from_sellers[3]}},{{$earning_from_sellers[4]}},{{$earning_from_sellers[5]}},{{$earning_from_sellers[6]}},{{$earning_from_sellers[7]}},{{$earning_from_sellers[8]}},{{$earning_from_sellers[9]}},{{$earning_from_sellers[10]}},{{$earning_from_sellers[11]}},{{$earning_from_sellers[12]}}],
