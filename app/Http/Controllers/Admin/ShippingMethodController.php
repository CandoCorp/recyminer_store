...
class ShippingMethodController extends Controller
{
    ...
    {
        $shipping_methods = ShippingMethod::where(['creator_type' => 'seller'])->whereNotIn('id', [1])->get();
        return view('admin-views.shipping-method.by-seller', compact('shipping_methods'));
    }
